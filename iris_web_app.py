...
st.title("Iris Flower Web Application")

st.write("""
# Iris Flower Prediction with Random Forest Algorithm
## This section predicts the **Iris flower** type based on sepal length, sepal width, petal length, and petal width!
""")
...
st.write("""
# Iris Flower Clustering with K-Means Algorithm
## This section cluster the **Iris flower** based on sepal length and petal length!
""")
